...
const MobileCategoriesFilter = ({ categories, activeFilter, handleFilterChange }: {
  ...
  return (
    <div className="bg-[#1A1A1A] py-2">
      <div 
        className="overflow-x-auto mx-[35px]" 
        style={{
          scrollbarWidth: 'none',
        ...
        <div className="flex min-w-max gap-0">
          {categories.map((category, index) => (
            <React.Fragment key={category}>
              <button
                className={`
                  px-4 py-2 text-sm font-extrabold uppercase whitespace-nowrap
              ...
              {index < categories.length - 1 && (
                <div className="w-1 bg-white self-stretch" />
              )}
            </React.Fragment>
          ))}
        </div>
...
const MobileNewsCarousel = ({ articles, activeFilter }: {
  ...
  return (
    <div className="bg-[#1A1A1A] relative">
      {/* Container da imagem com setas nas laterais */}
      <div className="relative mt-4">
        {/* Seta esquerda - 8px da borda */}
        {articles.length > 1 && (
          <button
            onClick={prevSlide}
            className="absolute left-2 top-1/2 transform -translate-y-1/2 text-white z-10 flex items-center justify-center"
          >
            <ArrowIcon direction="left" />
          </button>
        )}

        {/* Container da imagem - com margin de 35px */}
        <div className="mx-[35px]">
          <motion.div
            className="relative overflow-hidden h-[215px] cursor-grab active:cursor-grabbing rounded-[2px]"
            drag="x"
        ...
        {/* Seta direita - 8px da borda */}
        {articles.length > 1 && (
          <button
            onClick={nextSlide}
            className="absolute right-2 top-1/2 transform -translate-y-1/2 text-white z-10 flex items-center justify-center"
          >
      ...
      {/* Conteúdo abaixo da imagem - com margin de 35px */}
      <div className="mx-[35px] py-4 text-white bg-[#1A1A1A] h-[100px]">
        {/* Título */}
        <h3 
          className="text-white font-bold text-base leading-tight mb-2 overflow-hidden"
          style={{
            display: '-webkit-box',
            WebkitLineClamp: 2,
...
const CategoriesFilter = ({ categories, activeFilter, handleFilterChange }: {
  ...
  return (
    <div className="w-full bg-red-600 relative h-[65px]">
      <div className="h-full flex items-center relative">
              ...
              <React.Fragment key={`${category}-${currentOffset}-${index}`}>
                <button
                  className={`
                    ...
                    whitespace-nowrap font-extrabold uppercase text-sm 
                ...
                {index < visibleCategories.length - 1 && (
                  <div className="w-2 bg-black opacity-70 self-stretch mx-3" />
                )}
              </React.Fragment>
            ))}
          </div>
        ...
        <button 
          onClick={moveNext}
          className="absolute right-6 top-1/2 transform -translate-y-1/2 p-2"
        >
          <Image
            src="/arrow.png"
            alt="Próximo"
    ...
    <div className="w-full min-h-full my-4">
      ...
      <div className="block md:hidden">
        ...
        <div className="bg-[#1A1A1A]">
          {/* Header Mobile - com margin de 35px */}
          <div className="mx-[35px] py-3">
      ...
      <div className="hidden md:block">
        ...
        <div className="bg-white text-white pt-4 pb-0 sm:p-8 mt-4 mb-0 mx-[35px]">
              ...
              <>
                ...
                <div className="flex justify-center mt-12">
                  <Link 
                    ...
                    className="inline-flex items-center gap-2 text-black text-sm font-bold"
                  >
                    Ver tudo
